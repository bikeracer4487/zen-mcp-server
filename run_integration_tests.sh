...
# Doug-Zen MCP Server - Run Integration Tests
...
echo "🧪 Running Integration Tests for Doug-Zen MCP Server"
echo "=============================================="
echo "These tests use real API calls with your configured keys"
echo ""

# Activate virtual environment
if [[ -f ".doug-zen_venv/bin/activate" ]]; then
    source .doug-zen_venv/bin/activate
